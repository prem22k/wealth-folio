        ...
        <div className="bg-background-light dark:bg-background-dark font-display text-white overflow-hidden min-h-screen flex w-full flex-row">
            ...
            <div className="hidden lg:flex flex-1 relative mesh-gradient items-center justify-center p-20 overflow-hidden border-r border-white/5">
                <div className="z-10 flex flex-col items-start gap-8 max-w-lg">
                    ...
                    <div className="runway-graphic flex items-center justify-center">
                        {/* Stylized Runway Calculator Graphic */}
                        <svg className="w-full h-full" viewBox="0 0 100 100">
                            <circle className="text-white/5" cx="50" cy="50" fill="transparent" r="40" stroke="currentColor" strokeWidth="8"></circle>
                            <circle className="text-primary progress-ring-circle" cx="50" cy="50" fill="transparent" r="40" stroke="currentColor" strokeDasharray="251.2" strokeDashoffset="180" strokeLinecap="round" strokeWidth="8"></circle>
                            {/* Trend Lines */}
                            <path d="M35 60 L45 50 L55 55 L65 45" fill="none" stroke="white" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path>
                            <circle cx="65" cy="45" fill="white" r="2"></circle>
                        </svg>
                        <div className="absolute inset-0 flex flex-col items-center justify-center">
                            <span className="text-4xl font-bold tracking-tight">18.4</span>
                            <span className="text-[10px] uppercase tracking-widest text-slate-400 font-bold">Months Runway</span>
                        </div>
                    </div>
            ...
            <main className="flex-1 flex flex-col items-center justify-center p-6 sm:p-12 relative dark:bg-[#0a0a1a]">
                <div className="w-full max-w-[440px] glass-panel p-8 sm:p-10 rounded-xl shadow-2xl">
                    <header className="mb-8">
                        ...
                        <p className="text-slate-400 text-sm font-normal">Create a secure account and begin your financial scan.</p>
                    </header>
                    <button
