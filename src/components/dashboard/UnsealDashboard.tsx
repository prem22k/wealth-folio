                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="glass-panel rounded-2xl lg:col-span-2 relative min-h-[320px] flex flex-col items-center justify-center p-8 overflow-hidden group">
                        ...
                        <div className="relative z-10 w-full max-w-2xl flex flex-col gap-6 items-center text-center">
                            <div className="space-y-2 flex flex-col items-center">
                                ...
                                <h3 className="text-3xl font-bold text-white">Ask your personal CFO</h3>
                                <p className="text-slate-400 max-w-md mx-auto">Get instant insights on your spending, investments, and wealth leaks.</p>
                            </div>
                            {/* Input */}
                            <div className="w-full relative group/input">
                                ...
                                <div className="relative flex items-center bg-[#0a0a12] rounded-xl px-4 py-4 border border-white/10 shadow-2xl">
                                    <span className="material-symbols-outlined text-slate-400 mr-3 animate-pulse">colors_spark</span>
                                    <input
                                        ...
                                        type="text"
                                    />
                                    <button className="ml-2 p-2 bg-white/10 hover:bg-white/20 rounded-lg text-white transition-colors">
                    ...
                    <div className="glass-panel rounded-2xl lg:col-span-3 min-h-[400px] relative p-8 flex flex-col overflow-hidden">
                        <div className="flex flex-col md:flex-row justify-between items-start md:items-center relative z-10 mb-6">
                            <div>
                                <h3 className="text-slate-400 text-sm font-medium uppercase tracking-wider mb-1">Net Wealth Stream</h3>
                            ...
                            <div className="flex gap-2 mt-4 md:mt-0">
                                <button className="px-4 py-2 rounded-lg text-xs font-medium bg-white/5 text-white hover:bg-white/10 transition border border-white/5">1M</button>
                                <button className="px-4 py-2 rounded-lg text-xs font-medium bg-primary text-white shadow-lg shadow-primary/25">6M</button>
                                <button className="px-4 py-2 rounded-lg text-xs font-medium bg-white/5 text-white hover:bg-white/10 transition border border-white/5">1Y</button>
                            </div>
                        </div>
                        {/* Chart */}
                            ...
                            <svg className="absolute inset-0 w-full h-full overflow-visible" preserveAspectRatio="none" viewBox="0 0 1200 400">
                                <defs>
                                    <linearGradient id="wealthGradient" x1="0" x2="0" y1="0" y2="1">
                                        <stop offset="0%" stopColor="#3623e1" stopOpacity="0.6"></stop>
                                        <stop offset="100%" stopColor="#3623e1" stopOpacity="0"></stop>
                                    </linearGradient>
                                ...
                                <path d="M0,350 C200,340 300,200 450,240 C600,280 750,50 900,100 C1050,150 1100,20 1200,50 V400 H0 Z" fill="url(#wealthGradient)"></path>
                                <path className="drop-shadow-[0_0_20px_rgba(99,102,241,0.5)]" d="M0,350 C200,340 300,200 450,240 C600,280 750,50 900,100 C1050,150 1100,20 1200,50" fill="none" stroke="#6366f1" strokeLinecap="round" strokeWidth="4"></path>
                                <circle className="animate-pulse" cx="1200" cy="50" fill="#fff" r="6"></circle>
                                <circle className="animate-ping" cx="1200" cy="50" fill="none" r="12" stroke="#fff" strokeOpacity="0.3"></circle>
                            </svg>
                        </div>
